...
class SplashScreenSecond : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnRegister.setOnClickListener {
            Toast.makeText(this@SplashScreenSecond, "Register clicked!", Toast.LENGTH_SHORT).show()
    ...
    private fun termsAndConditionsStyling() {
        val clickableSpan = object : ClickableSpan() {
            override fun onClick(widget: View) {
                Toast.makeText(this@SplashScreenSecond, "Clicked!", Toast.LENGTH_SHORT).show()
            }
        }
